  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-950 to-slate-900 px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 -top-40 h-96 w-96 rounded-full bg-white/3 blur-3xl" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#f5f5f5] shadow-2xl shadow-black/30">
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-8 shadow-2xl backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              ...
              className="h-12 border-white/10 bg-white/5 text-center text-xl tracking-widest text-white placeholder:tracking-normal focus:border-white/40 focus:ring-white/10"
            />
            ...
            <Button
              ...
              className="h-12 w-full bg-[#f5f5f5] text-base font-semibold text-[#171717] hover:bg-white disabled:opacity-50"
            >
              {loading ? (
